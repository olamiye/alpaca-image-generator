...
background_btn.onclick = function () {
  show([style_section, secondary_heading, background_section]);
  hide([
    neck_section,
    ears_section,
    leg_section,
...
neck_btn.onclick = function () {
  show([style_section, secondary_heading, neck_section]);
...
ears_btn.onclick = function () {
  show([style_section, secondary_heading, ears_section]);
...
leg_btn.onclick = function () {
  show([style_section, secondary_heading, leg_section]);
...
hair_btn.onclick = function () {
  show([style_section, secondary_heading, hair_section]);
...
mouth_btn.onclick = function () {
  show([style_section, secondary_heading, mouth_section]);
...
eyes_btn.onclick = function () {
  show([style_section, secondary_heading, eyes_section]);
...
accessories_btn.onclick = function () {
  show([style_section, secondary_heading, accessories_section]);
...
bgBtnAll.forEach((item) => {
  item.addEventListener('click', (event) => {
    document.getElementById('background').src =
      '/alpaca-generator-assets/alpaca/backgrounds/' +
      event.target.value +
      '.png';
...
neckBtnAll.forEach((item) => {
  item.addEventListener('click', (event) => {
    document.getElementById('neck').src =
      '/alpaca-generator-assets/alpaca/neck/' + event.target.value + '.png';
...
earsBtnAll.forEach((item) => {
  item.addEventListener('click', (event) => {
    document.getElementById('ears').src =
      '/alpaca-generator-assets/alpaca/ears/' + event.target.value + '.png';
...
legBtnAll.forEach((item) => {
  item.addEventListener('click', (event) => {
    document.getElementById('leg').src =
      '/alpaca-generator-assets/alpaca/leg/' + event.target.value + '.png';
...
hairBtnAll.forEach((item) => {
  item.addEventListener('click', (event) => {
    document.getElementById('hair').src =
      '/alpaca-generator-assets/alpaca/hair/' + event.target.value + '.png';
...
mouthBtnAll.forEach((item) => {
  item.addEventListener('click', (event) => {
    document.getElementById('mouth').src =
      '/alpaca-generator-assets/alpaca/mouth/' + event.target.value + '.png';
...
eyesBtnAll.forEach((item) => {
  item.addEventListener('click', (event) => {
    document.getElementById('eyes').src =
      '/alpaca-generator-assets/alpaca/eyes/' + event.target.value + '.png';
...
accBtnAll.forEach((item) => {
  item.addEventListener('click', (event) => {
    document.getElementById('accessories').src =
      '/alpaca-generator-assets/alpaca/accessories/' +
      event.target.value +
      '.png';
